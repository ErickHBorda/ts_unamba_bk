...
('admin', 'admin@unamba.edu.pe', '1234', 'ADMINISTRADOR');


SHOW TABLES;

SELECT codigo, nombre, modalidad FROM CATEGORIA_DOCENTE;
SELECT codigo, nombre FROM CONDICION_LABORAL;
